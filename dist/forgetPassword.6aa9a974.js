...
},{}],"src/js/View/forgetPassword.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ForgetPassword = /*#__PURE__*/function (_View) {
  _inherits(ForgetPassword, _View);
  var _super = _createSuper(ForgetPassword);
  function ForgetPassword() {
    var _this;
    _classCallCheck(this, ForgetPassword);
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "_email", 'tysoab@gmail.com');
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector('.forgetPassword-form'));
    _defineProperty(_assertThisInitialized(_this), "_currentAccount", void 0);
    _this.addHandlerChangePassword();
    return _this;
  }
  _createClass(ForgetPassword, [{
    key: "addHandlerChangePassword",
    value: function addHandlerChangePassword() {
      var _this2 = this;
      this._parentElement.addEventListener('submit', function (e) {
        e.preventDefault();
        _this2._currentAccount = model.state.users.find(function (user) {
          return user.email === _this2._email;
        });
        var formDatas = Object.fromEntries(_toConsumableArray(new FormData(_this2._parentElement)));
        if (!formDatas.password || !formDatas.cPassword) _this2.handlerErrorMessage('All fields is required!');
        if (formDatas.password !== formDatas.cPassword) _this2.handlerErrorMessage('Password not match!');
        if (formDatas.password === formDatas.cPassword && formDatas.password !== '' && formDatas.cPassword !== '') {
          _this2._currentAccount.password = formDatas.password;
          var data = {
            email: _this2._email,
          ...
          _this2._clearField();
          _this2._parentElement.closest('.forgetPassword').innerHTML = "<p class=\"success-msg\">Password changed! you will be redirected to login page...</p>";
          _this2._redirectTimeout();
        }
      });
    }
  }, {
    key: "_redirectTimeout",
    value: function _redirectTimeout() {
      clearTimeout(this._intervalId);
      this._intervalId = setTimeout(function () {
        window.location.href = "index.html";
      }, 2500);
...
;
var newPassword = new ForgetPassword();
},{"./view.js":"src/js/View/view.js","../model.js":"src/js/model.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/View/forgetPassword.js"], null)
//# sourceMappingURL=/forgetPassword.6aa9a974.js.map