...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/View/pageNavigation.js":[function(require,module,exports) {
"use strict";
...
var PageNavigation = /*#__PURE__*/function () {
  function PageNavigation() {
    ...
    _defineProperty(this, "_slideIndex", 0);
    _defineProperty(this, "_searchBar", document.querySelector('.search-bar-toggle'));
    _defineProperty(this, "_toggleUserProfile", document.querySelector('.user-toggle'));
    _defineProperty(this, "_menuToggle", document.querySelector('.menu-toggle'));
    this._searchToggle();
  ...
  _createClass(PageNavigation, [{
    key: "_searchToggle",
    value: function _searchToggle() {
      this._searchBar.addEventListener('click', function () {
        document.querySelector('.search-bar-container').classList.toggle('search-bar-container-toggle');
      });
    }
  }, {
    key: "handlerUserProfile",
    value: function handlerUserProfile() {
      this._toggleUserProfile.addEventListener('click', function () {
        document.querySelector('.toggle-user-profile').classList.toggle('toggled-user-profile');
      });
    }
  }, {
    key: "handlerMenuToggle",
    value: function handlerMenuToggle() {
      var _this = this;
      this._menuToggle.addEventListener('click', function () {
        ...
        if (document.querySelector('header nav').classList.contains('header-nav-toggle')) {
          _this._menuToggle.innerHTML = '<i class="fa fa-xmark"></i>';
        } else {
          _this._menuToggle.innerHTML = '<i class="fa-solid fa-bars"></i>';
        }
      });
    }
  }, {
...
},{}],"src/js/View/propertyView.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var PropertyView = /*#__PURE__*/function (_View) {
  _inherits(PropertyView, _View);
  var _super = _createSuper(PropertyView);
  function PropertyView() {
    var _this;
    _classCallCheck(this, PropertyView);
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector('.post-wrapper'));
    _defineProperty(_assertThisInitialized(_this), "_propertyLink", void 0);
    return _this;
  }
  _createClass(PropertyView, [{
    key: "addHandlerProperty",
    value: function addHandlerProperty(handler) {
    ...
    value: function _generateMarkup() {
      var _this2 = this;
      var markup = this._data.map(function (property) {
        return _this2.markupElement(property);
      }).join('');
      return markup;
    }
  }, {
    key: "markupElement",
    value: function markupElement(property) {
      return "\n    <div class=\"post-container\" data-propertyId=\"".concat(property.id, "\">\n    \n    \n        <div class=\"post-img\">\n    \n        <div class=\"property-type\">\n        <small>").concat(property.propertyType, "</small>\n        </div>\n        <a href=\"landing-page.html?propertyId=").concat(property.id, "\" class=\"property-link\">\n        <img src=\"").concat(property.images[0], "\">\n        </a>\n        <div class=\"post-img-stats\">\n    \n        ").concat(property.postImgStat ? "<div><i class=\"fas fa-toilet\"></i> ".concat(property.postImgStat.toilet, "</div>\n            <div><I class=\"fa fa-bed\"></i> ").concat(property.postImgStat.bed, "</div>\n            <div><i class=\"fa-solid fa-bath\"></i> ").concat(property.postImgStat.bath, "</div>") : '', "\n    \n        </div>\n    \n        </div><!---post-img close--->\n    \n        <div class=\"post-description\">\n        <h3>").concat(property.name, "</h3>\n        <span>").concat(property.price, "</span>\n        <p><i class=\"fas fa-map-marker-alt\"></i> ").concat(property.location, "</p>\n        <small><i class=\"fa-sharp fa-regular fa-clock\"></i> ").concat(property.date, "</small>\n        \n        <a href=\"landing-page.html?propertyId=").concat(property.id, "\" class=\"property-link\">Learn more</a>\n        \n        </div>\n    \n        </div>\n    ");
    }
  }, {
    key: "handlerLink",
    value: function handlerLink() {
      var links = document.querySelectorAll('.post-container');
      links.forEach(function (link) {
        link.addEventListener('click', function (e) {
          e.preventDefault();
          var id = link.dataset.propertyid;
...
var _default = new PropertyView();
exports.default = _default;
},{"./view.js":"src/js/View/view.js"}],"src/js/View/loginView.js":[function(require,module,exports) {
"use strict";
...
var LoginView = /*#__PURE__*/function (_View) {
  ...
  function LoginView() {
    ...
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector('.login-form'));
    _defineProperty(_assertThisInitialized(_this), "_CreateAccuntLink", document.querySelector('.create-acc-link'));
    _defineProperty(_assertThisInitialized(_this), "_forgetPassword", document.querySelector('.forget-password-el'));
    _defineProperty(_assertThisInitialized(_this), "_appContainer", document.querySelector('.app-container'));
    _this._loginSession();
    _this._logoutSession();
    _this._forgetPassword.addEventListener('click', _this.handlerForgetPassword.bind(_assertThisInitialized(_this)));
    return _this;
  }
  _createClass(LoginView, [{
    key: "_loginSession",
    value: function _loginSession() {
      var data = JSON.parse(localStorage.getItem('login-session'));
      if (!data) return;
    ...
    key: "_submitLogin",
    value: function _submitLogin(e) {
      e.preventDefault();
      var formDatas = Object.fromEntries(_toConsumableArray(new FormData(this._parentElement)));
      if (!formDatas.username || !formDatas.password) {
        this.handlerErrorMessage('All Fields is Required!');
      }
      if (formDatas.username && formDatas.password) {
        this._currentAcount = this._data.find(function (user) {
          return user.username === formDatas.username && user.password === formDatas.password;
        });
    ...
    key: "handlerForgetPassword",
    value: function handlerForgetPassword(e) {
      e.preventDefault();
      this._hideForm();
...
exports.default = _default;
},{"./view.js":"src/js/View/view.js"}],"src/js/controller.js":[function(require,module,exports) {
"use strict";

var _pageNavigation = require("./View/pageNavigation.js");
var model = _interopRequireWildcard(require("./model.js"));
var _propertyView = _interopRequireDefault(require("./View/propertyView.js"));
var _loginView = _interopRequireDefault(require("./View/loginView.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var controlProperty = function controlProperty() {
  _propertyView.default.render(model.state.properties);
};
var controlLogin = function controlLogin() {
  _loginView.default.render(model.state.users);
};
var init = function init() {
  _pageNavigation.pageNavigation.autoSlideShow();
  _propertyView.default.addHandlerProperty(controlProperty);
  _loginView.default.addHandlerLogin(controlLogin);
};
init();
},{"./View/pageNavigation.js":"src/js/View/pageNavigation.js","./model.js":"src/js/model.js","./View/propertyView.js":"src/js/View/propertyView.js","./View/loginView.js":"src/js/View/loginView.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
