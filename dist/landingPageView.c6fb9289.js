...
},{}],"src/js/View/landingPageView.js":[function(require,module,exports) {
"use strict";

var _pageNavigation = require("./pageNavigation.js");
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var LadingPageView = /*#__PURE__*/function (_View) {
  _inherits(LadingPageView, _View);
  var _super = _createSuper(LadingPageView);
  function LadingPageView() {
    var _this;
    _classCallCheck(this, LadingPageView);
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "_id", void 0);
    _defineProperty(_assertThisInitialized(_this), "_properties", model.state.properties);
    _defineProperty(_assertThisInitialized(_this), "_currentProperty", void 0);
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector('.property-container'));
    _this.addHandlerProper();
    _this._logoutSession();
    return _this;
  }
  _createClass(LadingPageView, [{
    key: "addHandlerProper",
    value: function addHandlerProper() {
      var _this2 = this;
      window.addEventListener('load', function () {
        var urlParams = new URLSearchParams(window.location.search);
        _this2._id = urlParams.get('propertyId');
        _this2._currentProperty = _this2._properties.find(function (property) {
          return property.id === _this2._id;
        });
        _this2._parentElement.insertAdjacentHTML('afterbegin', _this2._generateMarkup());
      });
    }
  }, {
    key: "_generateMarkup",
    value: function _generateMarkup() {
      return "\n    <h3>".concat(this._currentProperty.name, "</h3>\n        <div class=\"post-gallery\">\n                  <img src=\"").concat(this._currentProperty.images[0], "\" style=\"width:100%\">\n                </div>\n        </div>\n        <div class=\"post-description\">\n            <p>").concat(this._currentProperty.name, "</p>\n            <span>N").concat(this._currentProperty.price, "</span>\n            <p><i class=\"fas fa-map-marker-alt\"></i> ").concat(this._currentProperty.location, "</p>\n            <small><i class=\"fa-sharp fa-regular fa-clock\"></i> ").concat(this._currentProperty.date, "</small>\n            <div class=\"post-description-stats\">\n\n    ").concat(this._currentProperty.postImgStat ? "<div><i class=\"fas fa-toilet\"></i> ".concat(this._currentProperty.postImgStat.toilet, "</div>\n        <div><I class=\"fa fa-bed\"></i> ").concat(this._currentProperty.postImgStat.bed, "</div>\n        <div><i class=\"fa-solid fa-bath\"></i> ").concat(this._currentProperty.postImgStat.bath, "</div>") : '', "\n\n    <a href=\"tel:+2349032765986\" class=\"callus\">Call: +2349032765986</a>\n\n    </div>\n            </div><!-----description close---->\n\n            <div class=\"full-description\">\n                <h3>Full Description</h3>\n                <p>\n                ").concat(this._currentProperty.fullDesc, "\n                </p>\n                <small><i class=\"fa-sharp fa-regular fa-clock\"></i> ").concat(this._currentProperty.date, "</small>\n            </div>\n\n            <div class=\"map\">\n            <h3>Location on Map</h3>\n            <iframe src=\"").concat(this._currentProperty.locationOnMap, "\"></iframe>\n            </map>\n    ");
    }
  }]);
  return LadingPageView;
}(_view.default);
var landingPage = new LadingPageView();
},{"./pageNavigation.js":"src/js/View/pageNavigation.js","./view.js":"src/js/View/view.js","../model.js":"src/js/model.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/View/landingPageView.js"], null)
//# sourceMappingURL=/landingPageView.c6fb9289.js.map