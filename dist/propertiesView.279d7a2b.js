...
},{}],"src/js/View/propertiesView.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var PropertiesView = /*#__PURE__*/function (_View) {
  _inherits(PropertiesView, _View);
  var _super = _createSuper(PropertiesView);
  function PropertiesView() {
    var _this;
    _classCallCheck(this, PropertiesView);
    ...
    _defineProperty(_assertThisInitialized(_this), "_filterContainer", document.querySelector('.btn-filter'));
    _defineProperty(_assertThisInitialized(_this), "_btnLogout", document.querySelector('.user-toggle'));
    _this.addHandlerProperties();
    _this.handlerChange();
    _this._logoutSession();
    return _this;
  }
  _createClass(PropertiesView, [{
    key: "handlerChange",
    value: function handlerChange() {
      var _this2 = this;
      var selectOption = _toConsumableArray(new Set(this._properties.map(function (option) {
        return option.type;
      }))).map(function (option) {
        return "<option value=\"".concat(option, "\">").concat(option, "</option>");
      }).join('');
      this._filterContainer.insertAdjacentHTML('beforeend', selectOption);
      this._filterContainer.addEventListener('change', function () {
        var optionValue = _this2._filterContainer.value;
        if (!optionValue) return;
        _this2.addHandlerProperties(optionValue);
      });
    }
  }, {
    key: "addHandlerProperties",
    value: function addHandlerProperties() {
      var _this3 = this;
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var properties = type ? this._properties.filter(function (property) {
        return property.type === type;
      }) : this._properties;
      if (!properties) return;
      var markup = properties.map(function (property) {
        return _this3._generateMarkup(property);
      }).join('');
      this._parentElement.innerHTML = '';
      this._parentElement.insertAdjacentHTML('afterbegin', markup);
    }
    ...
    key: "_generateMarkup",
    value: function _generateMarkup(property) {
      return "\n  <div class=\"post-container\">\n  <div class=\"post-image\">\n  <a href=\"landing-page.html?propertyId=".concat(property.id, "\">\n  <img src=\"").concat(property.images[0], "\">\n  </a>\n  </div>\n  <div class=\"post-description\">\n    <div>\n      <h3>").concat(property.name, "</h3>\n      <span>N").concat(property.price, "</span>\n      <p><i class=\"fas fa-map-marker-alt\"></i> ").concat(property.location, "</p>\n      <small><i class=\"fa-sharp fa-regular fa-clock\"></i> ").concat(property.date, "</small>\n      <a href=\"landing-page.html?propertyId=").concat(property.id, "\">Learn more</a>\n      </div>\n  </div>\n  </div>\n  ");
    }
  }]);
  return PropertiesView;
}(_view.default);
var propertiesView = new PropertiesView();
},{"./pageNavigation.js":"src/js/View/pageNavigation.js","../model.js":"src/js/model.js","./view.js":"src/js/View/view.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/View/propertiesView.js"], null)
//# sourceMappingURL=/propertiesView.279d7a2b.js.map